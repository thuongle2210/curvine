...
"""
    ...
    FUSE_CLI_OPTIONS = [
        ...
        ('entry-timeout-ms', 'entry-timeout'),
        ('entry-timeout', 'entry-timeout'),
        ('attr-timeout-ms', 'attr-timeout'),
        ('attr-timeout', 'attr-timeout'),
        ('negative-timeout-ms', 'negative-timeout'),
    ...
    FUSE_TOML_ALIASES = {
        ...
        "entry_timeout_ms": "entry_timeout",
        "attr_timeout_ms": "attr_timeout",
        "negative_timeout_ms": "negative_timeout",
    }
...
def print_error_help() -> None:
    ...
    dataset_options = [
        ...
        ("entry-timeout", "FUSE entry timeout (DurationUnit: milliseconds or 1s/500ms)"),
        ("attr-timeout", "FUSE attr timeout (DurationUnit: milliseconds or 1s/500ms)"),
