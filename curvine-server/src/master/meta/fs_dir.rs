...
impl FsDir {
    ...
    pub fn acquire_new_block(
        ...
        println!(
            "DEBUG: at FsDir, acquire_new_block, commit_blocks = {:?}",
            commit_blocks
        );
        let op_ms = LocalTime::mills();
        ...
        println!(
            "DEBUG: at FsDir, file: {:?}, new_block_id: {:?}",
            file, new_block_id
        );
        println!(
            "DEUBG: at FsDir, blocks before add new block: {:?}",
            file.blocks
        );
        ...
        println!(
            "DEUBG: at FsDir, at acquire_new_block after complete: {:?}",
            file.blocks
        );
        ...
        println!(
            "DEUBG: at FsDir, blocks after add new block: {:?}",
            file.blocks
        );
